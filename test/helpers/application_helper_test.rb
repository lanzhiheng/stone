...
class ApplicationHelperTest < ActionView::TestCase
  test "should return navbar link" do
    assert_dom_equal %{<ul class="nav"><li><a href="/">Lastest</a></li><li><a href="/blog">Blog</a></li><li><a href="/translation">Translation</a></li><li><a href="/about">About</a></li><li><a href="/contact">Contact</a></li></ul>}, navbar
  end
