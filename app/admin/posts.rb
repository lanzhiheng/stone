...
ActiveAdmin.register Post do
  ...
  form do |f|
    ...
    def collection_of_tags
      ActsAsTaggableOn::Tag.most_used(20).map(&:name) | object.tag_list
    end
    ...
    f.inputs do
      ...
      f.input :tag_list, as: :select, input_html: { multiple: true }, collection: collection_of_tags
